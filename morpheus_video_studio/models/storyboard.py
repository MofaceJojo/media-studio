...
class StoryboardConfig:
    ...
    voice_id: Optional[str] = None             # Voice ID (for local/omnivoice/comfyui)
    ...
    tts_instruct: Optional[str] = None         # OmniVoice style instruct (omnivoice mode)
...
class StoryboardFrame:
    ...
    audio_duration: float = 0.0                # Narration audio duration before scene padding
