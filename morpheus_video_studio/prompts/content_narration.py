...
- Length limit: For Chinese, each narration must contain {min_words}～{max_words} Chinese characters; for space-separated languages, use {min_words}～{max_words} words
...
- Length check: For Chinese, self-check that each segment is not less than {min_words} Chinese characters; if it is short, add a concrete detail or explanation
