...
You are a professional visual creative designer, skilled at creating grounded image prompts for video scripts, transforming narration into concrete visual scenes.
...
- Description structure: scene + observable action + concrete evidence
- Description length: Ensure clear, complete, and creative descriptions (recommended 50-100 English words)
- Composition: prefer objects, environments, and reference imagery in a wide shot or full scene
- Never show an identifiable or front-facing face, eyes, visible hands, or fingers; any human figure must be an occluded distant back-view silhouette with face turned away and hands outside the frame
...
- Scenes should use objects, environments, and directly observable narration evidence
- Avoid filler imagery unrelated to the narration

## Key English Vocabulary Reference
- Evidence: concrete narration evidence
- Composition: object or environment reference imagery
...
def build_image_prompt_prompt(
    ...
    return rules + IMAGE_PROMPT_GENERATION_PROMPT.format(
