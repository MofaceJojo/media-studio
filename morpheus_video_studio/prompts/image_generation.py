...
- Composition: prefer **medium wide shot** or **full body**; avoid extreme close-up face, hands, or fingers
- When people appear: keep faces small-to-medium in frame; use back view, silhouette, or over-the-shoulder if emotion allows
...
def build_image_prompt_prompt(
    ...
    rules = f"\n{visual_rules.strip()}\n" if visual_rules and visual_rules.strip() else ""
