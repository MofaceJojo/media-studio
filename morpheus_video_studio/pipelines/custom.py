...
from morpheus_video_studio.pipelines.base import BasePipeline
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        morpheus_video_studio.pipelines["my_custom"] = CustomPipeline(morpheus_video_studio)
    ...
    async def __call__(
        ...
        from morpheus_video_studio.utils.template_util import resolve_template_path, get_template_type
        ...
        # from morpheus_video_studio.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from morpheus_video_studio.utils.content_generators import generate_image_prompts
...
# Use immediately
morpheus_video_studio.pipelines["quick"] = QuickPipeline(morpheus_video_studio)
result = await morpheus_video_studio.generate_video(text=content, pipeline="quick")
"""
