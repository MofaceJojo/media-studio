...
from morpheus_video_studio.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, morpheus_video_studio_core):
        ...
        Args:
            morpheus_video_studio_core: MorpheusVideoStudioCore instance (provides access to all services)
        """
        self.core = morpheus_video_studio_core
        
        # Quick access to services (convenience)
        self.llm = morpheus_video_studio_core.llm
        self.tts = morpheus_video_studio_core.tts
        self.media = morpheus_video_studio_core.media
        self.video = morpheus_video_studio_core.video
        
        # Backward compatibility alias
        self.image = morpheus_video_studio_core.media
