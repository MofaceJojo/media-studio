...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    def __init__(self, core):
        ...
        Args:
            core: MorpheusVideoStudioCore instance
        """
        super().__init__(core)
    ...
    async def __call__(
        ...
        **kwargs
        ...
        Args:
            ...
            source: Workflow source ("selfhost" or "selfhost")
    ...
    async def setup_environment(self, context: PipelineContext) -> PipelineContext:
        ...
        for i, asset_path in enumerate(assets, 1):
            ...
            if asset_type == "image":
                ...
                analysis_source = context.request.get("source", "selfhost")
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from morpheus_video_studio.prompts.asset_script_generation import build_asset_script_prompt
        ...
        try:
            ...
            metadata = {
                ...
                "config": {
                    ...
                    "source": ctx.request.get("source", "selfhost"),
                }
            }
