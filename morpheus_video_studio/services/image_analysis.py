...
class ImageAnalysisService(ComfyBaseService):
    ...
    - selfhost/analyse_image.json (default, cloud-based)
    - selfhost/analyse_image.json (local ComfyUI)
    
    Usage:
        # Use default (selfhost cloud)
        description = await morpheus_video_studio.image_analysis("path/to/image.jpg")
        
        # Use local ComfyUI
        description = await morpheus_video_studio.image_analysis(
            "path/to/image.jpg",
            source="selfhost"
        )
        
        # List available workflows
        workflows = morpheus_video_studio.image_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await morpheus_video_studio.image_analysis("temp/06.JPG")
        ...
        try:
            ...
            # Try format 2: Selfhost raw_data (text file URL)
