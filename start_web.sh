...
elif [ -x "/Users/mofacejojo/Pixelle-Video/.venv/bin/streamlit" ]; then
  /Users/mofacejojo/Pixelle-Video/.venv/bin/streamlit run web/app.py --server.address 127.0.0.1 --server.port 8501
else
