...
async def list_tts_workflows(morpheus_video_studio: MorpheusVideoStudioDep):
    ...
    Returns list of local/self-hosted TTS workflows.
...
async def list_media_workflows(morpheus_video_studio: MorpheusVideoStudioDep):
    ...
    Returns list of all local/self-hosted media workflows.
    ...
    ```json
    {
        "workflows": [
            ...
            },
            {
                ...
                "display_name": "video_dreamshaper_m4_fast.json - selfhost",
                "source": "selfhost",
                "path": "workflows/selfhost/video_dreamshaper_m4_fast.json",
                "key": "selfhost/video_dreamshaper_m4_fast.json"
            }
        ]
    }
    ```
