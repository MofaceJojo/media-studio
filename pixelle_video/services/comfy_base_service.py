...
class ComfyBaseService:
    ...
    def __init__(self, config: dict, service_name: str, core=None):
        ...
        # Global ComfyUI config (for comfyui_url and optional API key)
    ...
    def _parse_workflow_file(self, file_path: Path, source: str) -> Dict[str, Any]:
        ...
        Args:
            ...
            source: Source directory name (e.g., "selfhost")
        ...
        # Check if it's a wrapper format from older workflow exports.
        if "source" in content:
            # Wrapper format: {"source": "selfhost", "workflow_id": "xxx", ...}
