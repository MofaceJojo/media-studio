...
**其他选项**：如果需要 AI 配图但不想本地部署 ComfyUI，可以使用 Local ComfyUI 云端服务。
...
- **云端方案**: OpenAI + Local ComfyUI（费用较高）
...
有其他问题？请查看 [故障排查](troubleshooting.md) 或提交 [Issue](https://github.com/MofaceJojo/morpheus-video-studio/issues)。
