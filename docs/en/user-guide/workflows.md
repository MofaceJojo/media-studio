...
Morpheus Video Studio is built on the ComfyUI architecture and supports custom workflows.
...
**Preset Workflows**:
- `selfhost/video_wan2.1_fusionx.json`: Cloud workflow (recommended)
  - Based on WAN 2.1 model
  - No local setup required, accessed via Local ComfyUI API
