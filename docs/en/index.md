...
[![Stars](https://img.shields.io/github/stars/MofaceJojo/morpheus-video-studio.svg?style=flat-square)](https://github.com/MofaceJojo/morpheus-video-studio/stargazers)
[![Issues](https://img.shields.io/github/issues/MofaceJojo/morpheus-video-studio.svg?style=flat-square)](https://github.com/MofaceJojo/morpheus-video-studio/issues)
[![License](https://img.shields.io/github/license/MofaceJojo/morpheus-video-studio.svg?style=flat-square)](https://github.com/MofaceJojo/morpheus-video-studio/blob/main/LICENSE)
...
Simply input a **topic**, and Morpheus Video Studio will automatically:
...
1. **[Install Morpheus Video Studio](getting-started/installation.md)** - Download and install the project
   - 🪟 **Windows Users (Recommended)**: Use the [All-in-One Package](https://github.com/MofaceJojo/morpheus-video-studio/releases/latest), no Python installation required
...
!!! success "Completely free to run!"
    ...
    - **Cloud Solution**: Use OpenAI + Local ComfyUI (higher cost but no local setup required)
...
- 🐛 **Found a bug**: Submit an [Issue](https://github.com/MofaceJojo/morpheus-video-studio/issues)
- 💡 **Feature request**: Submit a [Feature Request](https://github.com/MofaceJojo/morpheus-video-studio/issues)
...
This project is licensed under the Apache License 2.0. See the [LICENSE](https://github.com/MofaceJojo/morpheus-video-studio/blob/main/LICENSE) file for details.
