...
After installation, you need to configure services to use Morpheus Video Studio.
...
Using Local ComfyUI cloud service, no local GPU required:

1. Register for a Local ComfyUI account
2. Obtain API Key
