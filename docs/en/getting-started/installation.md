...
This page will guide you through installing Morpheus Video Studio.
...
1. Visit [GitHub Releases](https://github.com/MofaceJojo/morpheus-video-studio/releases/latest) to download the latest version
...
Your browser should automatically open `http://localhost:8501` and display the Morpheus Video Studio web interface.
